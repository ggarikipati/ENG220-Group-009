...
st.title("📊 Project 2 - Monthly Averages Data")

try:
    data = pd.read_csv("./weapon_arrests_monthly_averages.csv")
    ...
    st.error("CSV file not found. Ensure it is placed in the root directory.")

st.write("ℹ️ Tip: Use numeric columns for best results in visualizations.")
