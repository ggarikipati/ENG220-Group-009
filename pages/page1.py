...
st.title("📅 Project 1 - Monthly Arrest Data")

try:
    data = pd.read_csv("./weapon_arrests_monthly.csv")
...
st.write("ℹ️ Tip: Pie charts are best used with fewer than 10 unique categories.")
